...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.mode_combo.addItems(["NACA Generator", "UIUC Database"])
        ...
        self.points_slider.setRange(20, 500); self.points_slider.setValue(100)
        ...
        self.db_list.itemClicked.connect(self.load_uiuc_airfoil)
    ...
    def filter_db(self):
        ...
        for item in self.uiuc_data:
            if query in item['name'].lower():
                self.db_list.addItem(item['name'])
